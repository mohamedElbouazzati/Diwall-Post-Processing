...
#     DecisionTreeClassifier(),
#     RandomForestClassifier(),
#     MLPClassifier(random_state=2, max_iter=100),
#     AdaBoostClassifier(),
#     GaussianNB(),
#     QuadraticDiscriminantAnalysis(),
#     SGDClassifier(loss="hinge", penalty="l2", max_iter=100)
...
classifiers = [
    ...
    GaussianProcessClassifier(random_state=random_seed),
...
for name, clf in zip(names, classifiers):
    ...
    accura=metrics.accuracy_score(y_test, pred)*100
